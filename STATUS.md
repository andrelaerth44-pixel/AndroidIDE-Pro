...
| Build Center V2 | UI implemented | Pipeline, progress, problems and logs are modeled; the real event bridge remains the next build-panel task. |
...
2. Finish Build Center event/log integration.
3. Add real file-opening, build and navigation commands to Command Palette.
